...
export const adminApi = {
  ...
  updateApplicationStatus: (id: string, status: string) =>
    request(`/api/admin/job-applications/${encodeURIComponent(id)}/status`, { method: 'PATCH', body: { status } }),
  getApplicationResume: (id: string) =>
    request(`/api/admin/job-applications/${encodeURIComponent(id)}/resume`),
  ...
  disableUser: (id: string, disabled: boolean) =>
    request(`/api/admin/users/${encodeURIComponent(id)}/disable`, { method: 'PATCH', body: { disabled } }),
